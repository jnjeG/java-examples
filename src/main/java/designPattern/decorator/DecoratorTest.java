...
/**
 * 参考内容 http://blog.csdn.net/zuoxiaolong8810/article/details/9123533
 */
public class DecoratorTest {
    ...
    public static void main(String[] args) throws Exception {
        //文件路径可自行更换
        final String filePath = "/Users/chenjunjie/code/git/java-examples/src/main/java/designPattern/decorator/resources/test.txt";
