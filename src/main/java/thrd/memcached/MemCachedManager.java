...
public class MemCachedManager {
    ...
    static {
        ...
        String[] servers = { "192.168.1.21:11211", "192.168.1.22:11211", "192.168.1.23:11211" };
        // 设置服务器权重
...
//        memcachedClient.setCompressThreshold(64 * 1024);
    ...
    public static void main(String[] args) {
        ...
        MemCachedManager.add("user", user, new Date(1000 * 600));// 向Memcached中添加一个序列化的对象
